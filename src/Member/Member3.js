    ...
    <div className="enfp-all-wrap">
      <div className="enfp-content-wrap">
        ...
        <div className="enfp-contnent">
          <Routes>
            <Route path="enfpzone" element={<EnfpZone />}></Route>
            <Route path="enfplover" element={<EnfpLover />}></Route>
          </Routes>
        </div>
      </div>
          ...
          <div className="content">
            ...
            <div className="infoexpian">
              <ul>
                ...
                <li>
                  step8.Ne(외향 직관)가 주기능 수준으로 강하기 때문에 상황을
                  깊게 분석하는 능력은 떨어지는 편이지만, 반비례로 상황을 정말
                  쉴 틈없이 파악하려는 성질이 약점을 보완하기 때문에 눈치가 빠른
